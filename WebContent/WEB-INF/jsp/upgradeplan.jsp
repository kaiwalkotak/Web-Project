				...
				<div id="page-content">
					...
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="gi gi-comments sidebar-nav-icon"></i>Upgrade Plan 
							</h1>
						</div>
									...
									<c:forEach var="tableDetails" items="${dataTableList}"
										...
										<tr id="mainCatTr_${tableDetails[0]}">
											...
											<c:forEach begin="0" end="${fn:length(tableDetails)-1}"
												varStatus="dataIndex">
												<c:if test="${dataIndex.index ne 9 && dataIndex.index ne 0}">
													<td align="center">${tableDetails[dataIndex.index]}</td>
												</c:if>
												
												<!-- dataIndex.index ne 5 &&  -->

												 <c:if test="${dataIndex.index eq 9  && dataIndex.index ne 0}">
				...
				.on(
						...
						function() {
							...
							$
									.ajax({
										type : "GET",
										url : "${pageContext.request.contextPath}/masters/setTicketType",
