				...
				<div id="page-content">
					...
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="gi gi-comments sidebar-nav-icon"></i>Admin Offer Master
							</h1>
						</div>
					...
					<div class="block full mainclass">
						...
						<div class="block-title">
							<h2>
								<strong>Admin </strong>Offer Master
							</h2>
					...
					<div class="block full subclass" style="display: none;">
						...
						<form:form id="addBannerForm" modelAttribute="addBannerForm"
							...
							<div class="form-group">
								<div class="col-md-12">
									<label for="example-nf-password">Offer Name</label> <input
										type="text" id="name" name="name" class="form-control"
										placeholder="Offer Name"> <input type="hidden"
		...
		function createNewBanner(id) {
			...
			if (id != "0") {
				$
						.ajax({
							type : "POST",
							url : "${pageContext.servletContext.contextPath}/masters/getOffer",
		...
		function saveBanner() {
			...
			if (document.getElementById("name").value != '') {
				...
				$
						.ajax({
							type : "POST",
							url : "${pageContext.servletContext.contextPath}/masters/addOffer",
							data : $("#addBannerForm").serialize(),
							dataType : 'json',
							async : false,
							success : function(response) {
								if (response.split("~")[0] == "y") {
									...
									if ('${isInnerCall}' == "1") {
										...
										window.location.href = "${pageContext.request.contextPath}/masters/clientdashboard/offermaster/0Nvmp2YMIWvYvXRJce6vOg==/1/"
												+ msgText + "/0";
		...
		function deleteProduct(id) {
			...
			if (confirm("Press OK to Delete this Offer!")) {
				...
				$
						.ajax({
							type : "GET",
							url : "${pageContext.servletContext.contextPath}/masters/deleteOffer",
							...
							success : function(response) {
								...
								if (response == false) {
									...
									alertDiv(
											"alert-danger",
											"This Offer has some data in system, so you can not delete this Testimonial!!");
								} else {
		...
		$('#addBannerForm').validate(
				{
					...
					messages : {
						...
						name : 'Please enter Campaign Offer Name!',
