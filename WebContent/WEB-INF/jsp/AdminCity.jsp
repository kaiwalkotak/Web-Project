...
<body>
				...
				<div id="page-content">
					...
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="gi gi-comments sidebar-nav-icon"></i>City Master
							</h1>
						</div>
					...
					<div class="block full mainclass">
						...
						<div class="block-title">
							<h2>
								<strong>Admin </strong>City Master
							</h2>
					...
					<div class="block full subclass" style="display: none;">
						...
						<form:form id="addBannerForm" modelAttribute="addBannerForm"
							...
							<div class="form-group">
								<div class="col-md-12">
									<label for="example-nf-password">City Name</label> <input
										type="text" id="city_name" name="city_name"
										class="form-control" placeholder="City Name"> <input
										type="hidden" id="bnr_id" name="bnr_id" value="0">
								</div>
							</div>
							<div class="form-group">
								<div class="col-md-12">
									<label for="example-nf-password">Select State</label>
									<div class="col-md-12">
	...
	<script>
		...
		function createNewBanner(id) {
			...
			if (id != "0") {
				$
						.ajax({
							type : "POST",
							url : "${pageContext.servletContext.contextPath}/masters/getCityDetail",
		...
		function saveBanner() {
			...
			$('#addBannerForm').validate().element("#city_name");
			...
			if (document.getElementById("city_name").value != ''
				...
				$
						.ajax({
							type : "POST",
							url : "${pageContext.servletContext.contextPath}/masters/addCity",
							data : $("#addBannerForm").serialize(),
							dataType : 'json',
							async : false,
							success : function(response) {
								if (response.split("~")[0] == "y") {
									...
									if ('${isInnerCall}' == "1") {
										...
										window.location.href = "${pageContext.request.contextPath}/masters/clientdashboard/Admincity/VWku18Lh7ZpfqC0lfCHvzA==/1/"
												+ msgText + "/0";
		...
		function deleteProduct(id) {
			...
			if (confirm("Press OK to Delete this City!")) {
				$("#top-loading-start").click();

				$
						.ajax({
							type : "GET",
							url : "${pageContext.servletContext.contextPath}/masters/deleteCity",
