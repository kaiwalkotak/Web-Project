...
function getmemberdata(){
	$.ajax({
		type:"POST",
		url:"${pageContext.servletContext.contextPath}/masters/getwcmemberdata",
...
function newForm(id){
	window.location.href="${pageContext.request.contextPath}/masters/member/wcstatuslist/mDknaEjBM1mMJgXalncXGQ==/0/-1/"+id;
}
</script>
        <style>
