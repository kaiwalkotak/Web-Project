...
<script
	src="${pageContext.request.contextPath}/resources/website/js/jquery-modal-video.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/website/js/custom-video.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/website/js/rangeslider.js"></script>
...
<script>
	function submitenquiry() {
		...
		if (document.getElementById("message").value != ''
			...
			if (email) {
				var mobile = ValidateMobile(document.getElementById("phnumber").value);
				if (mobile) {
...
<div class="feedback_container">
	<div class="feedback_hood clear_fix" data-enquiry="no"
		data-toggle="modal" data-target="#myModal">
		<img
			src="${pageContext.request.contextPath}/resources/website/images/Enquire_Now.jpg">
	</div>
	<div class="container">
		<h2>&nbsp;</h2>
		<!-- Modal -->
										...
										<div class="row">
											<div class="form-group col-xs-12">
												<label>Name:</label> <input type="text" name="full_name"
													...
													type="hidden" id="isActive" name="isActive" value="1">
											</div>
