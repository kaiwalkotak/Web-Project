  <!--**********************************
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="${pageContext.request.contextPath}/customer-dash/dashboard" class="brand-logo">
				<img class="logo-abbr" src="${pageContext.request.contextPath}/resources/website/member-dashboard/images/logo.png"  width="64px" height="64px" height="80" width="170">
				<img class="brand-title"   src="${pageContext.request.contextPath}/resources/website/member-dashboard/images/logo-text.png"  width="101" height="47">
            </a>
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="${pageContext.request.contextPath}/resources/website/member-dashboard/images/avatar/1.jpg">
													</div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									<div class="header-info">
										<span class="text-black"><strong>${sessionBean.cname}</strong></span>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="${pageContext.request.contextPath}/customer-dash/myprofile" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ml-2">Profile </span>
                                    </a>
                                     <a href="${pageContext.request.contextPath}/customer-dash/dashboard-changepassword" class="dropdown-item ai-icon">
                                        <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                        <span class="ml-2">Change Password</span>
                                    </a>
                                    <a href="${pageContext.request.contextPath}/logoutclient" class="dropdown-item ai-icon">
