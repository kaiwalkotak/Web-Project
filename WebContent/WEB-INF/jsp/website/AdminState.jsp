...
<body>
				...
				<div id="page-content">
					...
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="gi gi-comments sidebar-nav-icon"></i>State Master
							</h1>
						</div>
					...
					<div class="block full mainclass">
						...
						<div class="block-title">
							<h2>
								<strong>Admin </strong>State Master
							</h2>
					...
					<div class="block full subclass" style="display: none;">
						...
						<form:form id="addBannerForm" modelAttribute="addBannerForm"
							...
							<div class="form-group">
								<div class="col-md-12">
									<label for="example-nf-password">State Name</label> <input
										type="text" id="state_name" name="state_name" class="form-control"
							 ...
							 <div class="form-group">
								<div class="col-md-12">
									<label for="example-nf-password">Description</label> <input
										...
										class="form-control" placeholder="Offer Description">
								</div>
	...
	<script>
		...
		function createNewBanner(id) {
			...
			if (id != "0") {
				$
						.ajax({
							type : "POST",
							url : "${pageContext.servletContext.contextPath}/masters/getState",
		...
		function saveBanner() {
			...
			$('#addBannerForm').validate().element("#state_name");
			...
			if (document.getElementById("state_name").value != '') {
				...
				$
						.ajax({
							type : "POST",
							url : "${pageContext.servletContext.contextPath}/masters/addState",
							data : $("#addBannerForm").serialize(),
							dataType : 'json',
							async : false,
							success : function(response) {
								if (response.split("~")[0] == "y") {
									...
									if ('${isInnerCall}' == "1") {
										...
										window.location.href = "${pageContext.request.contextPath}/masters/clientdashboard/Adminstate/AKUmaIfcQaucrquJ7ccP3A==/1/"
												+ msgText + "/0";
		...
		function deleteProduct(id) {
			...
			if (confirm("Press OK to Delete this State!")) {
				$("#top-loading-start").click();

				$
						.ajax({
							type : "GET",
							url : "${pageContext.servletContext.contextPath}/masters/deleteState",
							...
							success : function(response) {
								...
								if (response == false) {
									...
									alertDiv(
											"alert-danger",
											"This Offer has some data in system, so you can not delete this State!!");
								} else {
									...
									alertDiv("alert-success",
											"State's Name Deleted successfully!!");
								}
							}
						});
