...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'dark'){
			...
			jQuery(".nav-header .logo-compact").attr("src", "https://qerza.dexignzone.com/xhtml/error-404.html");
			jQuery(".nav-header .brand-title").attr("src", "https://qerza.dexignzone.com/xhtml/error-404.html");
			
			setCookie('logo_src', 'https://qerza.dexignzone.com/xhtml/error-404.html');
			setCookie('logo_src2', 'https://qerza.dexignzone.com/xhtml/error-404.html');
		}else{
