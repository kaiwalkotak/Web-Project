				       ...
				       ${successMsg}
                        ...
                        <div class="block full mainclass">
                            ...
                            <div class="block-title">
                                <h2><strong>Sales Status </strong></h2>
...
function getmemberdata(){
	$.ajax({
		type:"POST",
		url:"${pageContext.servletContext.contextPath}/masters/getsalesmemberdata",
...
function newForm(id){
	window.location.href="${pageContext.request.contextPath}/masters/member/salestatuslist/MswnOx0BcbqoZ59Y42Ewrg==/0/-1/"+id;
}
</script>
        <style>
