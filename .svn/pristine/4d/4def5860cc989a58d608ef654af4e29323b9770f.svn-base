...
<body>
				...
				<div id="page-content">
					...
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="gi gi-drink sidebar-nav-icon"></i>Offer Inquiry
							</h1>
						</div>
					...
					<div class="block full">
						...
						<div class="block-title">
							<h2>
								<strong>Admin </strong>Offer Inquiry List
							</h2>
							...
							<div class="form-group">
								<div class="col-md-6">
									<div class="input-group input-daterange"
										data-date-format="mm/dd/yyyy" style="margin-bottom: 15px;">
										<input type="text" id="from" name="from"
											class="form-control text-center" placeholder="From">
										<span class="input-group-addon"><i
											class="fa fa-angle-right"></i></span> <input type="text" id="to"
											name="to" class="form-control text-center" placeholder="To">
									</div>
								</div>
								<div class="col-md-2">
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/helpers/ckeditor/ckeditor.js"></script>
