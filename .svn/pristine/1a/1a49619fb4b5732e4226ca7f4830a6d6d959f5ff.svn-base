...
<!DOCTYPE html>
<html class="no-js cover" lang="en"> 
    <head>
        <meta charset="utf-8">
   ...
   <body class="login">
    <div id="login">
        <h1><img src="${pageContext.request.contextPath}/resources/img/login-logo.png" alt="Karma Resorts and Hospitality" style="max-height:160px; width:auto; max-width:100%;"></h1>
        <c:url var="loginUrl" value="/chklogin" />
        <form id="loginform" method="post" name="loginForm" id="loginForm" action="${loginUrl}" class="form-horizontal" method="post">
                     ...
                     <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="username" name="ccode" class="form-control input-lg" placeholder="Username">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group form-actions">
                        ...
                        <div class="col-xs-8 text-right">
                            <button type="submit" class="btn btn-lg btn-primary button-large"><i class="fa fa-angle-right"></i> Login </button>
                        </div>
                        <p>
                            <a href="/">Go to back</a>
                        </p>
