				...
				<div id="page-content">
					...
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="gi gi-comments sidebar-nav-icon"></i>Admin Testimonial
							</h1>
						</div>
					...
					<ul class="breadcrumb breadcrumb-top">
						<li>Dashboard</li>
						<li><a href="">Admin Testimonial</a></li>
					</ul>
					...
					<div class="block full mainclass">
						...
						<div class="block-title">
							<h2>
								<strong>Admin </strong>Testimonial
							</h2>
										...
										<tr id="mainCatTr_${tableDetails[0]}">
											...
											<c:forEach begin="0" end="${fn:length(tableDetails)-1}"
												...
												<c:if test="${dataIndex.index ne 0}">
													<c:if test="${dataIndex.index eq imageIndex}">
														<td><a
													...
													<c:if
														test="${dataIndex.index ne imageIndex && dataIndex.index ne 5}">
