                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                     <i class="gi gi-comments sidebar-nav-icon"></i>Sale Branch
                                </h1>
                            </div>
                        ...
                        <div class="block full  mainclass">
                            ...
                            <div class="block-title">
                                <h2><strong>Sale Branch </strong></h2>
                        ...
                        <div class="block full subclass" style="display: none;">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Add </strong>Sale Branch</h2>
                                    </div>
                                    ...
                                    <form:form id="addProductForm" modelAttribute="addProuct" method="POST" class="form-horizontal form-bordered">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                            	...
                                            	<input type="text" id="branch_name" name="branch_name" class="form-control" placeholder="Title">
...
function createNewProduct(id){
	...
	if(id!="0"){
	 $.ajax({
   			type:"POST",
   			url:"${pageContext.servletContext.contextPath}/masters/getSaleBranch",
   			data:$("#addProductForm").serialize()+"&mainPrdId="+id.split("_")[1],
   			dataType: 'json',
   			async:false,
   			success: function(response){
   				$("#branch_name").focus().val(response.branch_name);
...
function deleteProduct(id){
	...
	$.ajax({
		type:"GET",
		url:"${pageContext.servletContext.contextPath}/masters/deleteSaleBranch",
...
function saveProduct(){
	$('#addProductForm').validate().element("#branch_name");
	$('#addProductForm').validate().element("#address");
	$("#top-loading-start").click();
	$.ajax({
		type:"POST",
		url:"${pageContext.servletContext.contextPath}/masters/addSaleBranch",
		...
		success: function(response){
			if(response.split("~")[0] == "y"){
				...
				if('${isInnerCall}' == "1"){
					...
					$("#top-loading-stop").click();			
					window.location.href = "${pageContext.request.contextPath}/masters/clientdashboard/salebranch/cG8VhNYIqezMCTK0sDPmrQ==/1/"+msgText+"/0";
