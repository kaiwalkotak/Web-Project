...
<body>
			...
			<div id="main-container">
				...
				<div id="page-content">
					...
					<div class="block full subclass" style="display: none;">
						...
						<form:form id="addVideoSlideForm"
							modelAttribute="addVideoSlideForm" method="POST"
							...
							<div class="form-group">
								<div class="col-md-12">
									<label for="example-nf-password">Video URL</label> <input
							...
							<div class="form-group">
								<div class="col-md-3">
									<label for="example-nf-password">Upload Photo</label> <input
										type="file" id="up2" name="" class="form-control"
							...
							<div class="form-group form-actions" style="text-align: center;">
								<a href="#" class="btn btn-primary"
									onclick="saveVideoSlideInfo()"><i class="fa fa-check"></i>
									Save</a>
							</div>
	...
	<script>
		...
		function createNewProduct(id) {
			...
			.ajax({
				type : "POST",
				url : "${pageContext.servletContext.contextPath}/masters/getVideoSlideImages",
							...
							success : function(response) {
								if (response.split("~")[0] == "y") {
									...
									if ('${isInnerCall}' == "1") {
										...
										$("#top-loading-stop").click();
										window.location.href = "${pageContext.request.contextPath}/masters/clientdashboard/VideoSlide/C5PtPW1Hsu9g1OQCL4b0nA==/1/"+ msgText + "/0";
									}
